[![React App CI](https://github.com/kanchanve/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/kanchanve/ci-cd-with-actions/actions/workflows/ci.yml)
